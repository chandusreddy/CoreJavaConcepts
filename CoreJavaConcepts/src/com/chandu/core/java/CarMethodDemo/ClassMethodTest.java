package com.chandu.core.java.CarMethodDemo;
...
public class ClassMethodTest {
	 ...
	 * directly�they must use an object reference. �Also, class methods cannot use
	 * the�this�keyword as there is no instance for�this�to refer to.
	 */
